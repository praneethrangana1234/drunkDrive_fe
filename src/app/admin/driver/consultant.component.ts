...
import { ConsultantaddComponent } from 'src/app/consultantadd/consultantadd.component';
@Component({
...
constructor(private _dialog: MatDialog, private _coreService: CoreService, private http:HttpClient ,private sanitizer: DomSanitizer,private seekerService: ConsultantService)
{
...
openaddemp()
{
 const dialogRef= this._dialog.open(ConsultantaddComponent);
